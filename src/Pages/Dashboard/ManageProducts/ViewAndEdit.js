...
function ViewAndEdit() {
  ...
  const onSubmit = async (updateData) => {
    const urlLink = `https://manufacturer-website-server-side-l833.onrender.com/carParts/${productsId}`;
    fetch(urlLink, {
      method: "PUT",
      headers: {
  ...
  useEffect(() => {
    const url = `https://manufacturer-website-server-side-l833.onrender.com/carParts/${productsId}`;
    fetch(url)
      .then((res) => res.json())
