...
function ViewOrder() {
  ...
  useEffect(() => {
    const url = `https://manufacturer-website-server-side-l833.onrender.com/manageOrders/${orderId}`;
    fetch(url)
      .then((res) => res.json())
  ...
  const onSubmit = async (updateData) => {
    const urlLink = `https://manufacturer-website-server-side-l833.onrender.com/manageOrders/${orderId}`;
    fetch(urlLink, {
      method: "PUT",
      headers: {
