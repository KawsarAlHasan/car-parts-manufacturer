    ...
    return (
        <div className='row container gx-5'>
            ...
            <div className='col-md-5 container my-3'>
                <h1 className='text-center'>Purchase <span className='text-danger'>Now</span></h1>
                <h6 className='text-center'>Available Quantity: {purchase.quantity}</h6>
                <h6 className='text-center'>Minimum Order Quantity: {purchase.orderQuantity}</h6>

                <Form onSubmit={handlePurchase}>
                    <Form.Group className="mb-3" controlId="formBasicEmail">
                        <Form.Label>Your Purchase Quantity:</Form.Label>
                        <Form.Control className='mb-2' name='quantity' type="number" placeholder="Enter Purchase Quantity" required />

                        <Form.Control className='mb-2' name='name' type="text" defaultValue={user.displayName || ""} placeholder="Enter Your Name" required />

                        <Form.Control className='mb-2' name='email' defaultValue={user.email} disabled />

                        <Form.Control className='mb-2' name='phone' type="number" placeholder="Enter Your Phone Number"/>

                        <Form.Control className='mb-2' name='address' type="text" placeholder="Enter Your Address"/>
                    </Form.Group>
